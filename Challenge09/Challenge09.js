...
const arrInc = (arr) => {
    ...
    result = arr.map(element => element + 10);  //forEach didnt work
...
const roundDecimals = (arr) => {
    // write your code here
    let result = [];
    result = arr.map(element => Math.round(element));
    return result;
}
// -------------------------------------------------------------------------------------------------------
...
const employeesBonus = (arr) => {
    ...
    arr.forEach(element => {
        ...
        if (element.workHours > 8) {
            ...
            element.salary = Number(element.salary.replace('$', '')) + 100;

            element.salary = `${element.salary}$`
        }
        else {

            element.salary = Number(element.salary.replace('$', '')) + 50;
